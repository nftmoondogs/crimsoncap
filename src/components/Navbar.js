      ...
      <style>
        {`
          @keyframes colorChange {
            ...
            50% { color: #e34b4b; fill: #e34b4b; } /* Light green color for both text and SVG fill */
        ...
        <div className="container mx-auto flex justify-between items-center px-4 xl:px-0">
          <div className="flex items-center">
            <a href="/" className="flex items-center">
              <img src="https://i.ibb.co/LCx5335/LOGO-SPEED-UP.gif" alt="ZERO" className="h-12 mr-3" />
              <h2 className="text-2xl font-bold flashy-text">$CrimsonCap</h2>
            </a>
          </div>
          <div className="flex items-center">
            {/* Twitter Icon */}
            <a href="https://twitter.com/crimsoncapsol" target="_blank" rel="noopener noreferrer" className="px-3">
            ...
            {/* Telegram Icon */}
            <a href="https://t.me/crimsoncapsol" target="_blank" rel="noopener noreferrer" className="px-3">
              <svg className="social-icon" width="30" height="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
